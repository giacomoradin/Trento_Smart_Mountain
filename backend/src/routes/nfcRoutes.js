...
import { nfcScanSchema, nfcTotemCreateSchema } from "../middleware/validationMiddleware.js";
import { listTotems, scanTotem, getNfcHistory, createTotem } from "../services/nfcService.js";
...
router.post("/totems", authenticate, requireRoles("admin"), async (req, res, next) => {
  try {
