...
interface TsmApiService {
  ...
  /**
   * Statistiche aggregate annuali/mensili (sessioni completate + attività libere).
   * Esposto da hikeSessionRoutes perché aggrega entrambe le sorgenti lato backend.
   */
